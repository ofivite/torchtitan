...
llama3_configs = {
    ...
    "1B-Proxy-nt": TransformerModelArgs(
        dim=256,
        n_layers=4,
        n_heads=4,
        n_kv_heads=4,
    ...
    "1B-Proxy-nt-x8-depth": TransformerModelArgs(
        dim=256,
        n_layers=32,
        n_heads=4,
        n_kv_heads=4,
    ...
    "1B-Proxy-nt-x4-width": TransformerModelArgs(
        ...
        n_heads=16,
        n_kv_heads=16,
        ffn_dim_multiplier=1.02325581395,  # to match proxy 2,75 MLP ratio
        multiple_of=64,
        qk_norm=True,
        norm_eps=1e-20,
        rope_theta=10000,
    ...
    "1B-Proxy-nt-x12-width": TransformerModelArgs(
        dim=3072,
        n_layers=4,
        n_heads=48,
        n_kv_heads=48,
        ffn_dim_multiplier=1.03106692703,  # to match proxy 2,75 MLP ratio
        multiple_of=64,
        qk_norm=True,
        norm_eps=1e-20,
        rope_theta=10000,
